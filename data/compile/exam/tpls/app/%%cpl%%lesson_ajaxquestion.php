			<form id="form1" name="form1" action="index.php?exam-app-lesson-ajax-questions">
                ...
                <div id="question_<?php echo $this->tpl_var['question']['questionid']; ?>" class="paperexamcontent">
					<div class="media well">
	                    ...
	                    <?php } ?>
						<div class="media-body well questionanswerbox" id="answernotice_<?php echo $this->tpl_var['question']['questionid']; ?>">
 ...
 $sid++; ?>
	                        ...
	                        <?php } elseif($this->tpl_var['questype']['questchoice'] == 5){ ?>
		                        <input type="text" class="input-xlarge" name="question[<?php echo $this->tpl_var['question']['questionid']; ?>]" value="<?php echo $this->tpl_var['sessionvars']['examsessionuseranswer'][$this->tpl_var['question']['questionid']]; ?>" rel="<?php echo $this->tpl_var['question']['questionid']; ?>"/>
		                    <?php } else { ?>
		                        <?php $sid = 0;
 foreach($this->tpl_var['selectorder'] as $key => $so){ 
 $sid++; ?>
